...
public class PiecesInputOperatorBaseCost {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < productsQuantity.length; i++) {
            ...
            if (type == 1){
                ...
                int panelPcsQuantity = scanner.nextInt();
                double m2Quantity = panelPcsQuantity*onePanelM2;
                System.out.println("the panel pieces quantity "+panelPcsQuantity+ "pcs can cover area of " +m2Quantity+ "m2");
                panelQuantityAcousticArray[i] = panelPcsQuantity;
                materialCostAcousticArray[i] = panelPcsQuantity * baseCostAcoustic;
                ...
                materialCostDekoArray[i] = panelPcsQuantity * baseCostDeko;
